...
public class StaticVariables {
	...
	public static final String nameClassPropertyName = "name";
	public static final String annotationNodeName = "Annotation";
	public static final String nameAnnotationPropertyName = "name";
	public static final String has_annotationPropertyName = "HAS_ANNOTATION";
	public static final String implementsInterfaceNodeName = "ImplementsInterface";
	public static final String implementsInterfacePropertyName = "name";
	public static final String implements_interfacePropertyName = "IMPLEMENTS_INTERFACE";
	public static final String methodNodeName = "Method";
	public static final String returningTypeMethodPropertyName = "returningType";
	public static final String packageMethodPropertyName = "package";
	public static final String nameMethodPropertyName = "name";
